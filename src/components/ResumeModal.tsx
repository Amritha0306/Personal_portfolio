      ...
      {open && (
        ...
        >
          ...
          <motion.div
            ...
            className="relative flex h-[85vh] w-full max-w-4xl flex-col overflow-hidden rounded-xl border border-navy-700 bg-navy-900 shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between border-b border-navy-700 px-5 py-4">
              <h3 className="font-display text-lg font-semibold text-slate-100">Resume</h3>
              <button
                type="button"
                onClick={onClose}
